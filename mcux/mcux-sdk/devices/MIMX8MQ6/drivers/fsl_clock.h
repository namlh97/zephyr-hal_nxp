    ...
    {                                                                                                                 \
        {kCLOCK_Osc25MClk,    kCLOCK_SysPll2Div5Clk, kCLOCK_SysPll2Div4Clk, kCLOCK_SysPll1Div3Clk, kCLOCK_SysPll1Clk, \
         kCLOCK_AudioPll1Clk, kCLOCK_VideoPll1Clk,   kCLOCK_SysPll3Clk}, /* Cortex-M4 Clock Root. */                  \
            ...
            {                                                                                                         \
                kCLOCK_Osc25MClk, kCLOCK_SysPll1Div3Clk,  kCLOCK_SysPll1Clk,                                          \
            ...
            {                                                                                                         \
                kCLOCK_Osc25MClk, kCLOCK_SysPll2Div8Clk,  kCLOCK_SysPll2Div20Clk,                                     \
                kCLOCK_SysPll2Div10Clk, kCLOCK_SysPll1Div5Clk, kCLOCK_AudioPll1Clk,                                   \
                kCLOCK_VideoPll1Clk, kCLOCK_ExtClk4}, /* Enet Ref Clock Root. */                                      \
            {                                                                                                         \
                kCLOCK_Osc25MClk, kCLOCK_SysPll2Div10Clk,  kCLOCK_AudioPll1Clk, kCLOCK_ExtClk1,                       \
                kCLOCK_ExtClk2, kCLOCK_ExtClk3, kCLOCK_ExtClk4, kCLOCK_VideoPll1Clk }, /* Enet Timer Clock Root. */   \
            {                                                                                                         \
                kCLOCK_Osc25MClk, kCLOCK_SysPll2Div20Clk,  kCLOCK_SysPll2Div8Clk,                                     \
...
#define CLOCK_ROOT_CONTROL_TUPLE                                                                                    \
    {                                                                                                               \
        kCLOCK_RootM4, kCLOCK_RootAxi, kCLOCK_RootEnetAxi, kCLOCK_RootNoc, kCLOCK_RootAhb, kCLOCK_RootAhb,          \
            kCLOCK_RootDramAlt, kCLOCK_RootSai1, kCLOCK_RootSai2, kCLOCK_RootSai3, kCLOCK_RootSai4, kCLOCK_RootSai5,\
            kCLOCK_RootSai6, kCLOCK_RootEnetRef, kCLOCK_RootEnetTimer, kCLOCK_RootEnetPhy, kCLOCK_RootQspi,         \
            kCLOCK_RootI2c1, kCLOCK_RootI2c2, kCLOCK_RootI2c3, kCLOCK_RootI2c4, kCLOCK_RootUart1, kCLOCK_RootUart2, \
            kCLOCK_RootUart3, kCLOCK_RootUart4, kCLOCK_RootEcspi1, kCLOCK_RootEcspi2,                               \
...
{
    kCLOCK_EnetAxiRootmuxOsc25m      = 0U, /*!< ENET AXI Clock from OSC 25M.*/
...
{
    kCLOCK_EnetRefRootmuxOsc25m       = 0U, /*!< ENET REF Clock from OSC 25M.*/
...
{
    kCLOCK_EnetTimerRootmuxOsc25m       = 0U, /*!< ENET TIMER Clock from OSC 25M.*/
...
{
    kCLOCK_EnetPhyRootmuxOsc25m       = 0U, /*!< ENET PHY Clock from OSC 25M.*/
